 ...
 */
class WzcategoriesController extends Zend_Controller_Action 
{
...
//        if ($nodeId > 0) $level+= 1;
        ...
        $treeview = MyProject_Model_Database::loadModel('werkzeugCategories');
