 ...
 */
class MacategoriesController extends Zend_Controller_Action {
    //put your code here
...
//        if ($nodeId > 0) $level+= 1;
        /* @var $treeview Model_MitarbeiterCategories */
        $treeview = MyProject_Model_Database::loadModel('mitarbeiterCategories');
...
//                die('#' . __LINE__ . ' oper: ' . $oper . ' insertNode('.print_r($data,1).','.$parent_id.','.$pos.')');
    ...
    {
        // Grid wird in View konfiguriert und gerendert
    }
