...
class Model_WerkzeugCategoriesLnk extends MyProject_Model_Database {
    //put your code here
    
    protected $_storageName = 'werkzeugCategoriesLnk';
     ...
     */
    public function fetchCategoryIdsByWerkzeugId($id) 
    {   
        /** @var $_s Model_Db_WerkzeugCategoriesLnk */
        $_s = $this->_storage;
        $fpKey = $this->_map['Werkzeug']['columns'];
