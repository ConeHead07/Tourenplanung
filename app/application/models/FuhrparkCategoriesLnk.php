...
class Model_FuhrparkCategoriesLnk extends MyProject_Model_Database {
    
    protected $_storageName = 'fuhrparkCategoriesLnk';
     ...
     */
    public function fetchCategoryIdsByFuhrparkId($id) 
    {   
        /** @var $_s Model_Db_FuhrparkCategoriesLnk */
        $_s = $this->_storage;
        $fpKey = $this->_map['Fuhrpark']['columns'];
