 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class MyProject_Cache_Backend_Apcu extends Zend_Cache_Backend implements Zend_Cache_Backend_ExtendedInterface
{
    /**
     * Log message
     */
    const TAGS_UNSUPPORTED_BY_CLEAN_OF_APCU_BACKEND = 'MyProject_Cache_Backend_Apcu::clean() : tags are unsupported by the Apcu backend';
    const TAGS_UNSUPPORTED_BY_SAVE_OF_APCU_BACKEND =  'MyProject_Cache_Backend_Apcu::save() : tags are unsupported by the Apcu backend';
