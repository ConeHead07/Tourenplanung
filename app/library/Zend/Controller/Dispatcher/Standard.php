...
class Zend_Controller_Dispatcher_Standard extends Zend_Controller_Dispatcher_Abstract
{
    ...
    public function isDispatchable(Zend_Controller_Request_Abstract $request)
    {
        ...
        if (false && strpos($className, 'perrzeiten')) {
            echo '#' . __LINE__ . ' ' . __FILE__ . ' ' . __METHOD__ . '(' . $className . ')' . PHP_EOL;
            echo '#' . __LINE__ . ' ' . __FILE__ . ' ' . __METHOD__ . ' finalClass' . $finalClass . ')' . PHP_EOL;
            echo '#' . __LINE__ . ' ' . __FILE__ . ' ' . __METHOD__ . ' fileSpec ' . $fileSpec . ')' . PHP_EOL;
            echo '#' . __LINE__ . ' ' . __FILE__ . ' ' . __METHOD__ . ' dispatchDir ' . $dispatchDir . ')' . PHP_EOL;
            echo '#' . __LINE__ . ' ' . __FILE__ . ' ' . __METHOD__ . ' loadFile ' . $test . ')' . PHP_EOL;
            ob_end_flush();
            exit;
        }
