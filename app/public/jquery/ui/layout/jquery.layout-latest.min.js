...
b){q=r[b];k=q.customHotkey;d=q.customHotkeyModifier;if(a&&"SHIFT"==d||g&&"CTRL"==d||g&&a)if(k&&u===(isNaN(k)||9>=k?k.toUpperCase().charCodeAt(0):k))return c=b,!1});if(!c||!w[c]||!r[c].closable||l[c].isHidden)return!0;ja(c);e.stopPropagation();return e.returnValue=!1}function H(e){if(J()){this&&this.tagName&&(e=this);var u;f(e)?u=w[e]:b(e).data("layoutRole")?u=b(e):b(e).parents().each(function(){if(b(this).data("layoutRole"))return u=b(this),!1});if(u&&u.length){var n=u.data("layoutEdge"),e=l[n];e.cssSaved&&
I(n);if(e.isSliding||e.isResizing||e.isClosed)e.cssSaved=!1;else{var a={zIndex:r.zIndexes.resizer_normal+1},g={},q=u.css("overflow"),k=u.css("overflowX"),d=u.css("overflowY");"visible"!=q&&(g.overflow=q,a.overflow="visible");k&&!k.match(/(visible|auto)/)&&(g.overflowX=k,a.overflowX="visible");d&&!d.match(/(visible|auto)/)&&(g.overflowY=k,a.overflowY="visible");e.cssSaved=g;u.css(a);b.each(m.allPanes,function(e,b){b!=n&&I(b)})}}}}function I(e){if(J()){this&&this.tagName&&(e=this);var u;f(e)?u=w[e]:
...
n.closable&&!n.initHidden?fa(e,!0,!0):n.initHidden||n.initClosed?Pa(e):c.noRoom||t.css("display","block");t.css("visibility","visible");n.showOverflowOnHover&&t.hover(H,I);l.initialized&&fb(e)}else w[e]=!1}},fb=function(e){var b=w[e],a=l[e],d=r[e];b&&(b.data("layout")&&ya(e,b.data("layout")),a.isVisible&&(l.initialized?ka():la(e),d.triggerEventsOnLoad?E("onresize_end",e):$a(e,!0)),d.initChildren&&d.children&&Ma(e))},kb=function(e){e=e?e.split(","):m.borderPanes;b.each(e,function(e,b){var a=w[b],g=
G[b],d=l[b],c=m[b].side,f={};if(a){switch(b){case "north":f.top=v.inset.top;f.left=v.inset.left;f.right=v.inset.right;break;case "south":f.bottom=v.inset.bottom;f.left=v.inset.left;f.right=v.inset.right;break;case "west":f.left=v.inset.left;break;case "east":f.right=v.inset.right}a.css(f);g&&d.isClosed?g.css(c,v.inset[c]):g&&!d.isHidden&&g.css(c,v.inset[c]+ca(b))}})},La=function(e){e=e?e.split(","):m.borderPanes;b.each(e,function(e,a){var d=w[a];G[a]=!1;P[a]=!1;if(d){var g=r[a],d=l[a],q="#"===g.paneSelector.substr(0,
1)?g.paneSelector.substr(1):"",c=g.resizerClass,f=g.togglerClass,h="-"+a,j=A[a],i=j.resizer=G[a]=b("<div></div>"),j=j.toggler=g.closable?P[a]=b("<div></div>"):!1;!d.isVisible&&g.slidable&&i.attr("title",g.tips.Slide).css("cursor",g.sliderCursor);i.attr("id",q?q+"-resizer":"").data({parentLayout:A,layoutPane:A[a],layoutEdge:a,layoutRole:"resizer"}).css(m.resizers.cssReq).css("zIndex",r.zIndexes.resizer_normal).css(g.applyDemoStyles?m.resizers.cssDemo:{}).addClass(c+" "+c+h).hover(Ka,$).hover(bb,cb).appendTo(p);
...
"none").appendTo(j),g.togglerContent_closed&&b("<span>"+g.togglerContent_closed+"</span>").data({layoutEdge:a,layoutRole:"togglerContent"}).addClass("content content-closed").css("display","none").appendTo(j),lb(a));var g=a,ua=b.layout.plugins.draggable,g=g?g.split(","):m.borderPanes;b.each(g,function(e,a){var g=r[a];if(!ua||!w[a]||!g.resizable)return g.resizable=!1,!0;var u=l[a],n=r.zIndexes,d=m[a],q="horz"==d.dir?"top":"left",c=G[a],k=g.resizerClass,f=0,j,h,K=k+"-drag",t=k+"-"+a+"-drag",i=k+"-dragging",
...
L),l&&c?(c.width(c.width()),b.each(j,function(b,e){e.resizeAll()})):c&&c.css(c.data("layoutCSS")).removeData("layoutCSS").removeData("layoutRole"),g.data("layout")||g.css(g.data("layoutCSS")).removeData("layoutCSS"));h&&h.remove();f&&f.remove();A[e]=w[e]=Q[e]=G[e]=P[e]=!1;n||ka()}},Ba=function(b){var a=w[b],d=a[0].style;r[b].useOffscreenClose?(a.data(m.offscreenReset)||a.data(m.offscreenReset,{left:d.left,right:d.right}),a.css(m.offscreenCSS)):a.hide().removeData(m.offscreenReset)},nb=function(b){var a=
w[b],b=r[b],d=m.offscreenCSS,c=a.data(m.offscreenReset),g=a[0].style;a.show().removeData(m.offscreenReset);b.useOffscreenClose&&c&&(g.left==d.left&&(g.left=c.left),g.right==d.right&&(g.right=c.right))},Pa=function(b,a){if(J()){var d=D.call(this,b),c=r[d],g=l[d],q=G[d];w[d]&&!g.isHidden&&!(l.initialized&&!1===E("onhide_start",d))&&(g.isSliding=!1,delete l.panesSliding[d],q&&q.hide(),!l.initialized||g.isClosed?(g.isClosed=!0,g.isHidden=!0,g.isVisible=!1,l.initialized||Ba(d),ea("horz"===m[d].dir?"":
...
if(e)return b();i=!d&&!j.isClosed&&"none"!=t.fxName_close;j.isMoving=!0;j.isClosed=!0;j.isVisible=!1;x?j.isHidden=!0:v&&(j.isHidden=!1);j.isSliding?sa(q,!1):ea("horz"===m[q].dir?"":"center",!1);Aa(q);i?(Da(q,!0),h.hide(t.fxName_close,t.fxSettings_close,t.fxSpeed_close,function(){Da(q,!1);j.isClosed&&g();b()})):(Ba(q),g(),b())})}},Aa=function(a){if(G[a]){var d=G[a],c=P[a],f=r[a],g=m[a].side,q=f.resizerClass,k=f.togglerClass,h="-"+a;d.css(g,v.inset[g]).removeClass(q+"-open "+q+h+"-open").removeClass(q+
"-sliding "+q+h+"-sliding").addClass(q+"-closed "+q+h+"-closed");f.resizable&&b.layout.plugins.draggable&&d.draggable("disable").removeClass("ui-state-disabled").css("cursor","default").attr("title","");c&&(c.removeClass(k+"-open "+k+h+"-open").addClass(k+"-closed "+k+h+"-closed").attr("title",f.tips.Open),c.children(".content-open").hide(),c.children(".content-closed").css("display","block"));Ra(a,!1);l.initialized&&ma()}},na=function(b,a,d,c){function g(){t.isMoving=!1;ab(f);t.isSliding||ea("vert"==
m[f].dir?"center":"",!1);Qa(f)}if(J()){var f=D.call(this,b),k=w[f],h=r[f],t=l[f],j,i;p.queue(function(b){if(!k||!h.resizable&&!h.closable&&!t.isShowing||t.isVisible&&!t.isSliding)return b();if(t.isHidden&&!t.isShowing)b(),Ca(f,!0);else{t.autoResize&&t.size!=h.size?ga(f,h.size,!0,!0,!0):U(f,a);var e=E("onopen_start",f);if("abort"===e)return b();"NC"!==e&&U(f,a);if(t.minSize>t.maxSize)return Ra(f,!1),!c&&h.tips.noRoomToOpen&&alert(h.tips.noRoomToOpen),b();a?sa(f,!0):t.isSliding?sa(f,!1):h.slidable&&
ia(f,!1);t.noRoom=!1;da(f);i=t.isShowing;delete t.isShowing;j=!d&&t.isClosed&&"none"!=h.fxName_open;t.isMoving=!0;t.isVisible=!0;t.isClosed=!1;i&&(t.isHidden=!1);j?(Da(f,!0),k.show(h.fxName_open,h.fxSettings_open,h.fxSpeed_open,function(){Da(f,!1);t.isVisible&&g();b()})):(nb(f),g(),b())}})}},Qa=function(a,d){var c=w[a],f=G[a],g=P[a],q=r[a],h=l[a],i=m[a].side,t=q.resizerClass,j=q.togglerClass,x="-"+a;f.css(i,v.inset[i]+ca(a)).removeClass(t+"-closed "+t+x+"-closed").addClass(t+"-open "+t+x+"-open");
h.isSliding?f.addClass(t+"-sliding "+t+x+"-sliding"):f.removeClass(t+"-sliding "+t+x+"-sliding");$(0,f);q.resizable&&b.layout.plugins.draggable?f.draggable("enable").css("cursor",q.resizerCursor).attr("title",q.tips.Resize):h.isSliding||f.css("cursor","default");g&&(g.removeClass(j+"-closed "+j+x+"-closed").addClass(j+"-open "+j+x+"-open").attr("title",q.tips.Close),$(0,g),g.children(".content-closed").hide(),g.children(".content-open").css("display","block"));Ra(a,!h.isSliding);b.extend(h,B(c));
l.initialized&&(ma(),la(a,!0));if(!d&&(l.initialized||q.triggerEventsOnLoad)&&c.is(":visible"))E("onopen_end",a),h.isShowing&&E("onshow_end",a),l.initialized&&E("onresize_end",a)},ob=function(b){function a(){g.isClosed?g.isMoving||na(c,!0):sa(c,!0)}if(J()){var d=T(b),c=D.call(this,b),g=l[c],b=r[c].slideDelay_open;d&&d.stopImmediatePropagation();g.isClosed&&d&&"mouseenter"===d.type&&0<b?N.set(c+"_openSlider",a,b):a()}},Sa=function(a){function c(){g.isClosed?sa(h,!1):g.isMoving||fa(h)}if(J()){var f=
T(a),h=D.call(this,a),a=r[h],g=l[h],q=g.isMoving?1E3:300;!g.isClosed&&!g.isResizing&&("click"===a.slideTrigger_close?c():a.preventQuickSlideClose&&g.isMoving||a.preventPrematureSlideClose&&f&&b.layout.isMouseOverElem(f,w[h])||(f?N.set(h+"_closeSlider",c,d(a.slideDelay_close,q)):c()))}},Da=function(b,a){var d=w[b],c=l[b],g=r[b],f=r.zIndexes;a?(ra(b,{animation:!0,objectsOnly:!0}),d.css({zIndex:f.pane_animate}),"south"==b?d.css({top:v.inset.top+v.innerHeight-d.outerHeight()}):"east"==b&&d.css({left:v.inset.left+
v.innerWidth-d.outerWidth()})):(wa(),d.css({zIndex:c.isSliding?f.pane_sliding:f.pane_normal}),"south"==b?d.css({top:"auto"}):"east"==b&&!d.css("left").match(/\-99999/)&&d.css({left:"auto"}),F.msie&&(g.fxOpacityFix&&"slide"!=g.fxName_open&&d.css("filter")&&1==d.css("opacity"))&&d[0].style.removeAttribute("filter"))},ia=function(b,a){var d=r[b],c=G[b],g=d.slideTrigger_open.toLowerCase();if(c&&(!a||d.slidable)){g.match(/mouseover/)?g=d.slideTrigger_open="mouseenter":g.match(/(click|dblclick|mouseenter)/)||
(g=d.slideTrigger_open="click");if(d.resizerDblClickToggle&&g.match(/click/))c[a?"unbind":"bind"]("dblclick."+L,ja);c[a?"bind":"unbind"](g+"."+L,ob).css("cursor",a?d.sliderCursor:"default").attr("title",a?d.tips.Slide:"")}},sa=function(b,a){function d(a){N.clear(b+"_closeSlider");a.stopPropagation()}var c=r[b],g=l[b],f=r.zIndexes,h=c.slideTrigger_close.toLowerCase(),i=a?"bind":"unbind",t=w[b],j=G[b];N.clear(b+"_closeSlider");a?(g.isSliding=!0,l.panesSliding[b]=!0,ia(b,!1)):(g.isSliding=!1,delete l.panesSliding[b]);
t.css("zIndex",a?f.pane_sliding:f.pane_normal);j.css("zIndex",a?f.pane_sliding+2:f.resizer_normal);h.match(/(click|mouseleave)/)||(h=c.slideTrigger_close="mouseleave");j[i](h,Sa);"mouseleave"===h&&(t[i]("mouseleave."+L,Sa),j[i]("mouseenter."+L,d),t[i]("mouseenter."+L,d));a?"click"===h&&!c.resizable&&(j.css("cursor",a?c.sliderCursor:"default"),j.attr("title",a?c.tips.Close:"")):N.clear(b+"_closeSlider")},da=function(a,d,c,f){var d=r[a],g=l[a],h=m[a],k=w[a],i=G[a],t="vert"===h.dir,j=!1;if("center"===
a||t&&g.noVerticalRoom)(j=0<=g.maxHeight)&&g.noRoom?(nb(a),i&&i.show(),g.isVisible=!0,g.noRoom=!1,t&&(g.noVerticalRoom=!1),ab(a)):!j&&!g.noRoom&&(Ba(a),i&&i.hide(),g.isVisible=!1,g.noRoom=!0);"center"!==a&&(g.minSize<=g.maxSize?(g.size>g.maxSize?ga(a,g.maxSize,c,!0,f):g.size<g.minSize?ga(a,g.minSize,c,!0,f):i&&(g.isVisible&&k.is(":visible"))&&(c=g.size+v.inset[h.side],b.layout.cssNum(i,h.side)!=c&&i.css(h.side,c)),g.noRoom&&(g.wasOpen&&d.closable?d.autoReopen?na(a,!1,!0,!0):g.noRoom=!1:Ca(a,g.wasOpen,
!0,!0))):g.noRoom||(g.noRoom=!0,g.wasOpen=!g.isClosed&&!g.isSliding,g.isClosed||(d.closable?fa(a,!0,!0):Pa(a,!0))))},za=function(b,a,d,c,g){if(J()){var b=D.call(this,b),f=r[b],h=l[b],g=g||f.livePaneResizing&&!h.isResizing;h.autoResize=!1;ga(b,a,d,c,g)}},ga=function(e,c,f,h,g){function q(){for(var a="width"===y?j.outerWidth():j.outerHeight(),a=[{pane:k,count:1,target:c,actual:a,correct:c===a,attempt:c,cssSize:C}],e=a[0],h={},q="Inaccurate size after resizing the "+k+"-pane.";!e.correct;){h={pane:k,
count:e.count+1,target:c};h.attempt=e.actual>c?d(0,e.attempt-(e.actual-c)):d(0,e.attempt+(c-e.actual));h.cssSize=("horz"==m[k].dir?x:z)(w[k],h.attempt);j.css(y,h.cssSize);h.actual="width"==y?j.outerWidth():j.outerHeight();h.correct=c===h.actual;1===a.length&&(Z(q,!1,!0),Z(e,!1,!0));Z(h,!1,!0);if(3<a.length)break;a.push(h);e=a[a.length-1]}t.size=c;b.extend(t,B(j));t.isVisible&&j.is(":visible")&&(qa&&qa.css(ua,c+v.inset[ua]),la(k));!f&&(!V&&l.initialized&&t.isVisible)&&E("onresize_end",k);f||(t.isSliding||
ea("horz"==m[k].dir?"":"center",V,g),ma());e=m.oppositeEdge[k];c<F&&l[e].noRoom&&(U(e),da(e,!1,f));1<a.length&&Z(q+"\nSee the Error Console for details.",!0,!0)}if(J()){var k=D.call(this,e),i=r[k],t=l[k],j=w[k],qa=G[k],ua=m[k].side,y=m[k].sizeType.toLowerCase(),V=t.isResizing&&!i.triggerEventsDuringLiveResize,A=!0!==h&&i.animatePaneSizing,F,C;p.queue(function(e){U(k);F=t.size;c=ba(k,c);c=d(c,ba(k,i.minSize));c=a(c,t.maxSize);if(c<t.minSize)e(),da(k,!1,f);else{if(!g&&c===F)return e();t.newSize=c;!f&&
(l.initialized&&t.isVisible)&&E("onresize_start",k);C=("horz"==m[k].dir?x:z)(w[k],c);if(A&&j.is(":visible")){var h=b.layout.effects.size[k]||b.layout.effects.size.all,h=i.fxSettings_size.easing||h.easing,v=r.zIndexes,p={};p[y]=C+"px";t.isMoving=!0;j.css({zIndex:v.pane_animate}).show().animate(p,i.fxSpeed_size,h,function(){j.css({zIndex:t.isSliding?v.pane_sliding:v.pane_normal});t.isMoving=!1;delete t.newSize;q();e()})}else j.css(y,C),delete t.newSize,j.is(":visible")?q():(t.size=c,b.extend(t,B(j))),
e()}})}},ea=function(a,c,f){a=(a?a:"east,west,center").split(",");b.each(a,function(a,e){if(w[e]){var h=r[e],k=l[e],i=w[e],t=!0,j={},m=b.layout.showInvisibly(i),p={top:ca("north",!0),bottom:ca("south",!0),left:ca("west",!0),right:ca("east",!0),width:0,height:0};p.width=v.innerWidth-p.left-p.right;p.height=v.innerHeight-p.bottom-p.top;p.top+=v.inset.top;p.bottom+=v.inset.bottom;p.left+=v.inset.left;p.right+=v.inset.right;b.extend(k,B(i));if("center"===e){if(!f&&k.isVisible&&p.width===k.outerWidth&&
p.height===k.outerHeight)return i.css(m),!0;b.extend(k,va(e),{maxWidth:p.width,maxHeight:p.height});j=p;k.newWidth=j.width;k.newHeight=j.height;j.width=z(i,j.width);j.height=x(i,j.height);t=0<=j.width&&0<=j.height;if(!l.initialized&&h.minWidth>p.width){var h=h.minWidth-k.outerWidth,p=r.east.minSize||0,y=r.west.minSize||0,V=l.east.size,A=l.west.size,C=V,D=A;0<h&&(l.east.isVisible&&V>p)&&(C=d(V-p,V-h),h-=V-C);0<h&&(l.west.isVisible&&A>y)&&(D=d(A-y,A-h),h-=A-D);if(0===h){V&&V!=p&&ga("east",C,!0,!0,f);
A&&A!=y&&ga("west",D,!0,!0,f);ea("center",c,f);i.css(m);return}}}else{k.isVisible&&!k.noVerticalRoom&&b.extend(k,B(i),va(e));if(!f&&!k.noVerticalRoom&&p.height===k.outerHeight)return i.css(m),!0;j.top=p.top;j.bottom=p.bottom;k.newSize=p.height;j.height=x(i,p.height);k.maxHeight=j.height;t=0<=k.maxHeight;t||(k.noVerticalRoom=!0)}t?(!c&&l.initialized&&E("onresize_start",e),i.css(j),"center"!==e&&ma(e),k.noRoom&&(!k.isClosed&&!k.isHidden)&&da(e),k.isVisible&&(b.extend(k,B(i)),l.initialized&&la(e))):
!k.noRoom&&k.isVisible&&da(e);i.css(m);delete k.newSize;delete k.newWidth;delete k.newHeight;if(!k.isVisible)return!0;"center"===e&&(k=F.isIE6||!F.boxModel,w.north&&(k||"IFRAME"==l.north.tagName)&&w.north.css("width",z(w.north,v.innerWidth)),w.south&&(k||"IFRAME"==l.south.tagName)&&w.south.css("width",z(w.south,v.innerWidth)));!c&&l.initialized&&E("onresize_end",e)}})},ka=function(a){D(a);if(p.is(":visible"))if(l.initialized){if(!0===a&&b.isPlainObject(r.outset)&&p.css(r.outset),b.extend(v,B(p,r.inset)),
v.outerHeight){!0===a&&kb();if(!1===E("onresizeall_start"))return!1;var d,c,f;b.each(["south","north","east","west"],function(b,a){w[a]&&(c=r[a],f=l[a],f.autoResize&&f.size!=c.size?ga(a,c.size,!0,!0,!0):(U(a),da(a,!1,!0,!0)))});ea("",!0,!0);ma();b.each(m.allPanes,function(b,a){(d=w[a])&&l[a].isVisible&&E("onresize_end",a)});E("onresizeall_end")}}else xa()},$a=function(a,d){var c=D.call(this,a);r[c].resizeChildren&&(d||ya(c),c=Y[c],b.isPlainObject(c)&&b.each(c,function(a,b){b.destroyed||b.resizeAll()}))},
la=function(a,c){if(J()){var h=D.call(this,a),h=h?h.split(","):m.allPanes;b.each(h,function(a,e){function h(a){return d(p.css.paddingBottom,parseInt(a.css("marginBottom"),10)||0)}function n(){var a=r[e].contentIgnoreSelector,a=t.nextAll().not(".ui-layout-mask").not(a||":lt(0)"),b=a.filter(":visible"),d=b.filter(":last");v={top:t[0].offsetTop,height:t.outerHeight(),numFooters:a.length,hiddenFooters:a.length-b.length,spaceBelow:0};v.spaceAbove=v.top;v.bottom=v.top+v.height;v.spaceBelow=d.length?d[0].offsetTop+
d.outerHeight()-v.bottom+h(d):h(t)}var i=w[e],t=Q[e],j=r[e],p=l[e],v=p.content;if(!i||!t||!i.is(":visible"))return!0;if(!t.length&&(Oa(e,!1),!t))return;if(!1!==E("onsizecontent_start",e)){if(!p.isMoving&&!p.isResizing||j.liveContentResizing||c||void 0==v.top)n(),0<v.hiddenFooters&&"hidden"===i.css("overflow")&&(i.css("overflow","visible"),n(),i.css("overflow","hidden"));i=p.innerHeight-(v.spaceAbove-p.css.paddingTop)-(v.spaceBelow-p.css.paddingBottom);if(!t.is(":visible")||v.height!=i){var z=t,j=
z;f(z)?j=w[z]:z.jquery||(j=b(z));z=x(j,i);j.css({height:z,visibility:"visible"});0<z&&0<j.innerWidth()?j.data("autoHidden")&&(j.show().data("autoHidden",!1),F.mozilla||j.css(m.hidden).css(m.visible)):j.data("autoHidden")||j.hide().data("autoHidden",!0);v.height=i}l.initialized&&E("onsizecontent_end",e)}})}},ma=function(a){a=(a=D.call(this,a))?a.split(","):m.borderPanes;b.each(a,function(a,e){var d=r[e],g=l[e],h=w[e],i=G[e],p=P[e],t;if(h&&i){var j=m[e].dir,y=g.isClosed?"_closed":"_open",A=d["spacing"+
y],C=d["togglerAlign"+y],y=d["togglerLength"+y],B;if(0===A)i.hide();else{!g.noRoom&&!g.isHidden&&i.show();"horz"===j?(B=v.innerWidth,g.resizerLength=B,h=b.layout.cssNum(h,"left"),i.css({width:z(i,B),height:x(i,A),left:-9999<h?h:v.inset.left})):(B=h.outerHeight(),g.resizerLength=B,i.css({height:x(i,B),width:z(i,A),top:v.inset.top+ca("north",!0)}));$(d,i);if(p){if(0===y||g.isSliding&&d.hideTogglerOnSlide){p.hide();return}p.show();if(!(0<y)||"100%"===y||y>B)y=B,C=0;else if(f(C))switch(C){case "top":case "left":C=
0;break;case "bottom":case "right":C=B-y;break;default:C=c((B-y)/2)}else h=parseInt(C,10),C=0<=C?h:B-y+h;if("horz"===j){var D=z(p,y);p.css({width:D,height:x(p,A),left:C,top:0});p.children(".content").each(function(){t=b(this);t.css("marginLeft",c((D-t.outerWidth())/2))})}else{var E=x(p,y);p.css({height:E,width:z(p,A),top:C,left:0});p.children(".content").each(function(){t=b(this);t.css("marginTop",c((E-t.outerHeight())/2))})}$(0,p)}if(!l.initialized&&(d.initHidden||g.isHidden))i.hide(),p&&p.hide()}}})},
lb=function(a){if(J()){var b=D.call(this,a),a=P[b],d=r[b];a&&(d.closable=!0,a.bind("click."+L,function(a){a.stopPropagation();ja(b)}).css("visibility","visible").css("cursor","pointer").attr("title",l[b].isClosed?d.tips.Open:d.tips.Close).show())}},Ra=function(a,d){b.layout.plugins.buttons&&b.each(l[a].pins,function(c,f){b.layout.buttons.setPinState(A,b(f),a,d)})},p=b(this).eq(0);if(!p.length)return Z(r.errors.containerMissing);if(p.data("layoutContainer")&&p.data("layout"))return p.data("layout");
var w={},Q={},G={},P={},aa=b([]),v=l.container,L=l.id,A={options:r,state:l,container:p,panes:w,contents:Q,resizers:G,togglers:P,hide:Pa,show:Ca,toggle:ja,open:na,close:fa,slideOpen:ob,slideClose:Sa,slideToggle:function(a){a=D.call(this,a);ja(a,!0)},setSizeLimits:U,_sizePane:ga,sizePane:za,sizeContent:la,swapPanes:function(a,c){function f(a){var d=w[a],c=Q[a];return!d?!1:{pane:a,P:d?d[0]:!1,C:c?c[0]:!1,state:b.extend(!0,{},l[a]),options:b.extend(!0,{},r[a])}}function h(a,c){if(a){var e=a.P,f=a.C,g=
a.pane,i=m[c],n=b.extend(!0,{},l[c]),k=r[c],u={resizerCursor:k.resizerCursor};b.each(["fxName","fxSpeed","fxSettings"],function(a,b){u[b+"_open"]=k[b+"_open"];u[b+"_close"]=k[b+"_close"];u[b+"_size"]=k[b+"_size"]});w[c]=b(e).data({layoutPane:A[c],layoutEdge:c}).css(m.hidden).css(i.cssReq);Q[c]=f?b(f):!1;r[c]=b.extend(!0,{},a.options,u);l[c]=b.extend(!0,{},a.state);e.className=e.className.replace(RegExp(k.paneClass+"-"+g,"g"),k.paneClass+"-"+c);La(c);i.dir!=m[g].dir?(e=p[c]||0,U(c),e=d(e,l[c].minSize),
za(c,e,!0,!0)):G[c].css(i.side,v.inset[i.side]+(l[c].isVisible?ca(c):0));a.state.isVisible&&!n.isVisible?Qa(c,!0):(Aa(c),ia(c,!0));a=null}}if(J()){var g=D.call(this,a);l[g].edge=c;l[c].edge=g;if(!1===E("onswap_start",g)||!1===E("onswap_start",c))l[g].edge=g,l[c].edge=c;else{var i=f(g),k=f(c),p={};p[g]=i?i.state.size:0;p[c]=k?k.state.size:0;w[g]=!1;w[c]=!1;l[g]={};l[c]={};P[g]&&P[g].remove();P[c]&&P[c].remove();G[g]&&G[g].remove();G[c]&&G[c].remove();G[g]=G[c]=P[g]=P[c]=!1;h(i,c);h(k,g);i=k=p=null;
w[g]&&w[g].css(m.visible);w[c]&&w[c].css(m.visible);ka();E("onswap_end",g);E("onswap_end",c)}}},showMasks:ra,hideMasks:wa,initContent:Oa,addPane:eb,removePane:Na,createChildren:Ma,refreshChildren:ya,enableClosable:lb,disableClosable:function(a,b){if(J()){var c=D.call(this,a),d=P[c];d&&(r[c].closable=!1,l[c].isClosed&&na(c,!1,!0),d.unbind("."+L).css("visibility",b?"hidden":"visible").css("cursor","default").attr("title",""))}},enableSlidable:function(a){if(J()){var a=D.call(this,a),b=G[a];b&&b.data("draggable")&&
(r[a].slidable=!0,l[a].isClosed&&ia(a,!0))}},disableSlidable:function(a){if(J()){var a=D.call(this,a),b=G[a];b&&(r[a].slidable=!1,l[a].isSliding?fa(a,!1,!0):(ia(a,!1),b.css("cursor","default").attr("title",""),$(null,b[0])))}},enableResizable:function(a){if(J()){var a=D.call(this,a),b=G[a],c=r[a];b&&b.data("draggable")&&(c.resizable=!0,b.draggable("enable"),l[a].isClosed||b.css("cursor",c.resizerCursor).attr("title",c.tips.Resize))}},disableResizable:function(a){if(J()){var a=D.call(this,a),b=G[a];
b&&b.data("draggable")&&(r[a].resizable=!1,b.draggable("disable").css("cursor","default").attr("title",""),$(null,b[0]))}},allowOverflow:H,resetOverflow:I,destroy:function(a,c){b(window).unbind("."+L);b(document).unbind("."+L);"object"===typeof a?D(a):c=a;p.clearQueue().removeData("layout").removeData("layoutContainer").removeClass(r.containerClass).unbind("."+L);aa.remove();b.each(m.allPanes,function(a,b){Na(b,!1,!0,c)});p.data("layoutCSS")&&!p.data("layoutRole")&&p.css(p.data("layoutCSS")).removeData("layoutCSS");
"BODY"===v.tagName&&(p=b("html")).data("layoutCSS")&&p.css(p.data("layoutCSS")).removeData("layoutCSS");h(A,b.layout.onDestroy);ib();for(var d in A)d.match(/^(container|options)$/)||delete A[d];A.destroyed=!0;return A},initPanes:J,resizeAll:ka,runCallbacks:E,hasParentLayout:!1,children:Y,north:!1,south:!1,west:!1,east:!1,center:!1},Ta;var R,Ua,O,Ea,ha,oa,S,i=b.layout.transformData(i,!0),i=b.layout.backwardCompatibility.renameAllOptions(i);if(!b.isEmptyObject(i.panes)){R=b.layout.optionsMap.noDefault;
ha=0;for(oa=R.length;ha<oa;ha++)O=R[ha],delete i.panes[O];R=b.layout.optionsMap.layout;ha=0;for(oa=R.length;ha<oa;ha++)O=R[ha],delete i.panes[O]}R=b.layout.optionsMap.layout;var xb=b.layout.config.optionRootKeys;for(O in i)Ea=i[O],0>b.inArray(O,xb)&&0>b.inArray(O,R)&&(i.panes[O]||(i.panes[O]=b.isPlainObject(Ea)?b.extend(!0,{},Ea):Ea),delete i[O]);b.extend(!0,r,i);b.each(m.allPanes,function(a,c){m[c]=b.extend(!0,{},m.panes,m[c]);Ua=r.panes;S=r[c];if("center"===c){R=b.layout.optionsMap.center;a=0;for(oa=
R.length;a<oa;a++)if(O=R[a],!i.center[O]&&(i.panes[O]||!S[O]))S[O]=Ua[O]}else{S=r[c]=b.extend(!0,{},Ua,S);var d=r[c],f=r.panes;d.fxSettings||(d.fxSettings={});f.fxSettings||(f.fxSettings={});b.each(["_open","_close","_size"],function(a,e){var h="fxName"+e,i="fxSpeed"+e,l="fxSettings"+e,j=d[h]=d[h]||f[h]||d.fxName||f.fxName||"none",m=b.effects&&(b.effects[j]||b.effects.effect&&b.effects.effect[j]);if("none"===j||!r.effects[j]||!m)j=d[h]="none";j=r.effects[j]||{};h=j.all||null;j=j[c]||null;d[i]=d[i]||
f[i]||d.fxSpeed||f.fxSpeed||null;d[l]=b.extend(!0,{},h,j,f.fxSettings,d.fxSettings,f[l],d[l])});delete d.fxName;delete d.fxSpeed;delete d.fxSettings;S.resizerClass||(S.resizerClass="ui-layout-resizer");S.togglerClass||(S.togglerClass="ui-layout-toggler")}S.paneClass||(S.paneClass="ui-layout-pane")});var Fa=i.zIndex,ta=r.zIndexes;0<Fa&&(ta.pane_normal=Fa,ta.content_mask=d(Fa+1,ta.content_mask),ta.resizer_normal=d(Fa+2,ta.resizer_normal));delete r.panes;var yb=r,pb=l;pb.creatingLayout=!0;h(A,b.layout.onCreate);
if(!1===E("onload_start"))Ta="cancel";else{var Va=p[0],W=b("html"),qb=v.tagName=Va.tagName,rb=v.id=Va.id,sb=v.className=Va.className,M=r,Ga=M.name,Wa={},Ha=p.data("parentLayout"),Ia=p.data("layoutEdge"),Xa=Ha&&Ia,pa=b.layout.cssNum,Ya,X;v.selector=p.selector.split(".slice")[0];v.ref=(M.name?M.name+" layout / ":"")+qb+(rb?"#"+rb:sb?".["+sb+"]":"");v.isBody="BODY"===qb;!Xa&&!v.isBody&&(Ya=p.closest("."+b.layout.defaults.panes.paneClass),Ha=Ya.data("parentLayout"),Ia=Ya.data("layoutEdge"),Xa=Ha&&Ia);
p.data({layout:A,layoutContainer:L}).addClass(M.containerClass);var tb={destroy:"",initPanes:"",resizeAll:"resizeAll",resize:"resizeAll"};for(Ga in tb)p.bind("layout"+Ga.toLowerCase()+"."+L,A[tb[Ga]||Ga]);Xa&&(A.hasParentLayout=!0,Ha.refreshChildren(Ia,A));p.data("layoutCSS")||(v.isBody?(p.data("layoutCSS",b.extend(C(p,"position,margin,padding,border"),{height:p.css("height"),overflow:p.css("overflow"),overflowX:p.css("overflowX"),overflowY:p.css("overflowY")})),W.data("layoutCSS",b.extend(C(W,"padding"),
{height:"auto",overflow:W.css("overflow"),overflowX:W.css("overflowX"),overflowY:W.css("overflowY")}))):p.data("layoutCSS",C(p,"position,margin,padding,border,top,bottom,left,right,width,height,overflow,overflowX,overflowY")));try{Wa={overflow:"hidden",overflowX:"hidden",overflowY:"hidden"};p.css(Wa);M.inset&&!b.isPlainObject(M.inset)&&(X=parseInt(M.inset,10)||0,M.inset={top:X,bottom:X,left:X,right:X});if(v.isBody)M.outset?b.isPlainObject(M.outset)||(X=parseInt(M.outset,10)||0,M.outset={top:X,bottom:X,
left:X,right:X}):M.outset={top:pa(W,"paddingTop"),bottom:pa(W,"paddingBottom"),left:pa(W,"paddingLeft"),right:pa(W,"paddingRight")},W.css(Wa).css({height:"100%",border:"none",padding:0,margin:0}),F.isIE6?(p.css({width:"100%",height:"100%",border:"none",padding:0,margin:0,position:"relative"}),M.inset||(M.inset=B(p).inset)):(p.css({width:"auto",height:"auto",margin:0,position:"absolute"}),p.css(M.outset)),b.extend(v,B(p,M.inset));else{var ub=p.css("position");(!ub||!ub.match(/(fixed|absolute|relative)/))&&
p.css("position","relative");p.is(":visible")&&(b.extend(v,B(p,M.inset)),1>v.innerHeight&&Z(M.errors.noContainerHeight.replace(/CONTAINER/,v.ref)))}pa(p,"minWidth")&&p.parent().css("overflowX","auto");pa(p,"minHeight")&&p.parent().css("overflowY","auto")}catch(zb){}jb();b(window).bind("unload."+L,ib);h(A,b.layout.onLoad);yb.initPanes&&xa();delete pb.creatingLayout;Ta=l.initialized}return"cancel"===Ta?null:A};b(function(){var a=b.layout.browser;a.msie&&(a.boxModel=b.support.boxModel)})})(jQuery);
(function(b){b.ui||(b.ui={});b.ui.cookie={acceptsCookies:!!navigator.cookieEnabled,read:function(a){for(var d=document.cookie,d=d?d.split(";"):[],c,f=0,h=d.length;f<h;f++)if(c=b.trim(d[f]).split("="),c[0]==a)return decodeURIComponent(c[1]);return null},write:function(a,d,c){var f="",h="",i=!1,c=c||{},y=c.expires||null,H=b.type(y);y&&y.toUTCString?h=y:"string"===H&&0<H&&(H=parseInt(H,10));if(null===y||"number"===H)h=new Date,0<y?h.setDate(h.getDate()+y):(h.setFullYear(1970),i=!0);h&&(f+=";expires="+
...
a.state.stateData=b.layout.transformData(d),c=b.extend({animateLoad:!1,includeChildren:a.options.stateManagement.includeChildren},c),a.state.initialized){var f=!c.animateLoad,h,i,y,H;b.each(b.layout.config.borderPanes,function(c,x){m=d[x];b.isPlainObject(m)&&(s=m.size,h=m.initClosed,i=m.initHidden,ar=m.autoResize,y=a.state[x],H=y.isVisible,ar&&(y.autoResize=ar),H||a._sizePane(x,s,!1,!1,!1),!0===i?a.hide(x,f):!0===h?a.close(x,!1,f):!1===h?a.open(x,!1,f):!1===i&&a.show(x,!1,f),H&&a._sizePane(x,s,!1,
!1,f))});if(c.includeChildren){var I,F;b.each(a.children,function(a,c){(I=d[a]?d[a].children:0)&&c&&b.each(c,function(a,b){F=I[a];b&&F&&b.loadState(F)})})}}else{var m=b.extend(!0,{},d);b.each(b.layout.config.allPanes,function(a,b){m[b]&&delete m[b].children});b.extend(!0,a.options,m)}},readState:function(a,d){"string"===b.type(d)&&(d={keys:d});d||(d={});var c=a.options.stateManagement,f=d.includeChildren,f=void 0!==f?f:c.includeChildren,c=d.stateKeys||c.stateKeys,h={isClosed:"initClosed",isHidden:"initHidden"},
i=a.state,y=b.layout.config.allPanes,H={},I,F,m,z,x,B;b.isArray(c)&&(c=c.join(","));for(var c=c.replace(/__/g,".").split(","),C=0,T=c.length;C<T;C++)I=c[C].split("."),F=I[0],I=I[1],0>b.inArray(F,y)||(m=i[F][I],void 0!=m&&("isClosed"==I&&i[F].isSliding&&(m=!0),(H[F]||(H[F]={}))[h[I]?h[I]:I]=m));f&&b.each(y,function(c,d){x=a.children[d];z=i.stateData[d];b.isPlainObject(x)&&!b.isEmptyObject(x)&&(B=H[d]||(H[d]={}),B.children||(B.children={}),b.each(x,function(a,c){c.state.initialized?B.children[a]=b.layout.state.readState(c):
z&&(z.children&&z.children[a])&&(B.children[a]=b.extend(!0,{},z.children[a]))}))});return H},encodeJSON:function(a){function d(a){var f=[],h=0,i,y,H,I=b.isArray(a);for(i in a)y=a[i],H=typeof y,"string"==H?y='"'+y+'"':"object"==H&&(y=d(y)),f[h++]=(!I?'"'+i+'":':"")+y;return(I?"[":"{")+f.join(",")+(I?"]":"}")}return d(a)},decodeJSON:function(a){try{return b.parseJSON?b.parseJSON(a):window.eval("("+a+")")||{}}catch(d){return{}}},_create:function(a){var d=b.layout.state,c=a.options.stateManagement;b.extend(a,
...
d.resizeWithWindow){var f=b.layout.browserZoom.ratio();f!==c.browserZoom&&(c.browserZoom=f,a.resizeAll());b.layout.browserZoom._setTimer(a)}},f)}},ratio:function(){function a(a,b){return(100*(parseInt(a,10)/parseInt(b,10))).toFixed()}var d=window,c=screen,f=document,h=f.documentElement||f.body,i=b.layout.browser,y=i.version,H,I,F;return i.msie&&8<y||!i.msie?!1:c.deviceXDPI&&c.systemXDPI?a(c.deviceXDPI,c.systemXDPI):i.webkit&&(H=f.body.getBoundingClientRect)?a(H.left-H.right,f.body.offsetWidth):i.webkit&&
(I=d.outerWidth)?a(I,d.innerWidth):(I=c.width)&&(F=h.clientWidth)?a(I,F):!1}};b.layout.onReady.push(b.layout.browserZoom._init)})(jQuery);