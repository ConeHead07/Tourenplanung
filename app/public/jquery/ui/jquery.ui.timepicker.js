...
(function ($, undefined) {
    ...
    $.extend(Timepicker.prototype, {
        ...
        _doKeyDown: function (event) {
            ////alert("#966 target typeof:"+typeof(target)+"; call this._getInst(target)"+arguments.callee);
        ...
        _doKeyUp: function (event) {
            ////alert("#966 event.target typeof:"+typeof(event.target)+"; call this._getInst(event.target)"+arguments.callee);
			var inst = $.timepicker._getInst(event.target);
        ...
        _showTimepicker: function (input) {
            ...
            $.timepicker._hideTimepicker();
			//alert("#303 input typeof:"+typeof(input)+"; call this._getInst(input)"+arguments.callee);
        ...
        _findPos: function (obj) {
            //alert("#686 obj typeof:"+typeof(obj)+"; call this._getInst(obj)"+arguments.callee);
        ...
        _getInst: function (target) {
            try {
                ...
                //alert("ERROR! target typeof:"+typeof(target)+"; "+arguments.caller);
	    ...
	    _setTimeTimepicker: function(target, time) {
		    //alert("#806 target typeof:"+typeof(target)+"; call this._getInst(target)");
        ...
        */
        ...
        selectHours: function (event) {
            var $td = $(event.currentTarget),
                id = $td.attr("data-timepicker-instance-id").replace("\\\\]", "\\]"),
                newHours = $td.attr("data-hour"),
                fromDoubleClick = event.data.fromDoubleClick,
                target = $(id),
                inst = this._getInst(target[0]);
            
			//alert("#884 id:"+id+"; target[0] typeof:"+typeof(target[0])+"; call this._getInst(target[0])");
        ...
        selectMinutes: function (event) {
            ...
            var target = $(id);
			//alert("#910 id:"+id+"; typeof(target[0]) :"+typeof(target[0])+"; call this._getInst(target[0])");
        ...
        _updateSelectedValue: function (inst) {
            //alert("#927 _updateSelectedValue");
            ...
            //alert("#934 before call this._updateAlternate");
        ...
        _getTimeTimepicker : function(input) {
            //alert("#999 input typeof:"+typeof(input)+"; call this._getInst(input)"+arguments.callee);
			var inst = this._getInst(input);
            return this._getParsedTime(inst);
        },
        _getHourTimepicker: function(input) {
            //alert("#1004 input typeof:"+typeof(input)+"; call this._getInst(input)"+arguments.callee);
			var inst = this._getInst(input);
            return inst.hours;
        },
        _getMinuteTimepicker: function(input) {
            //alert("#1009 input typeof:"+typeof(input)+"; call this._getInst(input)"+arguments.callee);
			var inst= this._getInst(input);
            return inst.minutes;
        }
