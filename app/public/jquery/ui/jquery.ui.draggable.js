...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_mouseDrag: function(event, noPropagation) {
		...
		if (!noPropagation) {
			var ui = this._uiHash();
			//alert("#168 jquery.ui.draggable.js _mouseDrag ui.position.top:"+ui.offset.top);
		...
		//alert("#174 jquery.ui.draggable.js _mouseDrag top: "+this.position.top);
	...
	_generatePosition: function(event) {
		...
		/*alert('pageY: '+pageY+"\n" +
		       "- this.offset.click.top: "+this.offset.click.top +"\n" +
			   "- this.offset.relative.top: "+this.offset.relative.top +"\n" +
			   "- this.offset.parent.top: "+this.offset.parent.top +"\n");	*/
		return {
			top: (
...
$.ui.plugin.add("draggable", "connectToSortable", {
	...
	drag: function(event, ui) {
		//alert("#521 jquery.ui.draggable.js");
...
$.ui.plugin.add("draggable", "scroll", {
	...
	drag: function(event, ui) {
		//alert("#655 jquery.ui.draggable.js");
...
$.ui.plugin.add("draggable", "snap", {
	...
	drag: function(event, ui) {
		//alert("#716 jquery.ui.draggable.js");
